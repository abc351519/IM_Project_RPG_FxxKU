...
void graph::init()
{
    ...
    BATTLE::ICON::RUNE_VITALITY_ICON.graph[3][2] = pixel;
    BATTLE::ICON::RUNE_VITALITY_ICON.graph[1][2] = pixel;
    pixel.change(unicode::DOWN_PIXEL,ansi_color::background::RUNE_VITALITY_STONE,ansi_color::font::RUNE_VITALITY_STONE_DARK);
    BATTLE::ICON::RUNE_VITALITY_ICON.graph[2][2] = pixel;
    ///////////////////////HEAL RUNE圖形（圓形）////////////////////
    ...
    BATTLE::ICON::RUNE_HEAL_ICON.graph[3][1] = pixel;
    
    pixel.change(unicode::DOWN_PIXEL,ansi_color::background::RUNE_HEAL_WHITE,ansi_color::font::RUNE_HEAL_STONE);
    BATTLE::ICON::RUNE_HEAL_ICON.graph[2][0] = pixel;
    pixel.change(unicode::UP_PIXEL,ansi_color::background::RUNE_HEAL_WHITE,ansi_color::font::RUNE_HEAL_STONE);
    ...
    ///////////////////////BUFF RUNE圖形（星形）////////////////////
    pixel.change(unicode::FULL_PIXEL,ansi_color::background::RUNEBAG_BACKGROUND,ansi_color::font::RUNE_BUFF_STONE);
    ...
    pixel.change(unicode::FULL_PIXEL,ansi_color::background::RUNEBAG_BACKGROUND,ansi_color::font::RUNE_BUFF_STONE_DARK);
    BATTLE::ICON::RUNE_BUFF_ICON.graph[0][1] = pixel;
    BATTLE::ICON::RUNE_BUFF_ICON.graph[2][2] = pixel;
    pixel.change(unicode::UP_PIXEL);
    BATTLE::ICON::RUNE_BUFF_ICON.graph[1][2] = pixel;
    
    pixel.change(unicode::CORNER_PIXEL_NOLD,ansi_color::background::RUNE_BUFF_STONE,ansi_color::font::RUNE_BUFF_STONE_DARK);
    BATTLE::ICON::RUNE_BUFF_ICON.graph[1][1] = pixel;
    ...
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[0][0] = pixel;
    pixel.change(unicode::L_PIXEL_4_8);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[0][1] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[0][2] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[0][3] = pixel;
    pixel.change(unicode::CORNER_PIXEL_NORU);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[0][4] = pixel;
    pixel.change(unicode::DOWN_PIXEL_6_8,ansi_color::background::RUNEBAG_FRAME_SELECTED,ansi_color::font::RUNEBAG_BACKGROUND);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[1][0] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[2][0] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[3][0] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[4][0] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[5][0] = pixel;
    ...
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[6][0] = pixel;
    pixel.change(unicode::CORNER_PIXEL_NOLU);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[6][4] = pixel;
    pixel.change(unicode::L_PIXEL_4_8,ansi_color::background::RUNEBAG_FRAME_SELECTED_DARK,ansi_color::font::RUNEBAG_BACKGROUND);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[6][1] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[6][2] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[6][3] = pixel;
    pixel.change(unicode::DOWN_PIXEL_2_8,ansi_color::background::RUNEBAG_BACKGROUND,ansi_color::font::RUNEBAG_FRAME_SELECTED_DARK);
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[1][4] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[2][4] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[3][4] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[4][4] = pixel;
    BATTLE::ICON::RUNE_FRAME_SELECTED.graph[5][4] = pixel;
    ///////////////////////////RUNE FRAME 圖形（取消選取框）/////////////////////////
    pixel.change(unicode::CORNER_PIXEL_NORD,ansi_color::background::RUNEBAG_BACKGROUND,ansi_color::font::RUNEBAG_FRAME);
